...
// ─── Data ────────────────────────────────────────────────────────────────────
const bilanPerso = [
  "Montée en compétences sur WordPress et Elementor",
  "Construire des mises en page complexes.", 
  "Suivre une maquette client avec précision.",
];

const steps = [
  {
    "title": "Analyse de la maquette & répartition des tâches",
    "content": "Étude de la maquette PDF du client et répartition des pages au sein de l’équipe de stagiaires.",
    "images": []
  },
  {
    "title": "Création des pages & structure",
    "content": "Intégration des pages avec menus, header, footer et sections héro, ajout des contenus, et ajustement des marges, polices et tailles selon la maquette.",
    "images": []
  },
  {
    "title": "Relectures & optimisations",
    "content": "Relectures régulières avec le maître de stage, optimisation des marges et application des retouches de la web designer sur toutes les pages.",
    "images": []
  },
  {
    "title": "Ajout des fonctionnalités",
    "content": "Intégration d’un bouton WhatsApp, formulaire de contact, code de réservation du client et ancres pour faciliter la navigation.",
    "images": []
  },
  {
    "title": "Finalisation & version anglaise",
    "content": "Dernière révision avec le maître de stage, retouches finales par la web designer, et création de la version anglaise du site.",
    "images": []
  }
]
          ...
          <div className="bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-xl rounded-[2rem] shadow-2xl relative p-8 md:p-12 border border-white/20">
            ...
            <div className="space-y-12">
              ...
              <header className="fade-up d1 border-b border-white/20 pb-6 flex gap-6 items-center">
                <div className="bg-teal-200 w-16 h-16 flex items-center justify-center rounded-xl overflow-hidden flex-shrink-0">
                  <img src={log} alt="Logo VRTueux" className="max-w-full max-h-full object-contain" />
                </div>
                <div>
                  ...
                  <Link to="/Projets" className="text-cyan-400 text-base underline hover:text-cyan-300 transition-colors">
                    ...
                    <Link to="/ParadisDuGeek" className="text-cyan-400 text-base underline hover:text-cyan-300 transition-colors">
              ...
              <section className="fade-up d2 space-y-4">
                ...
                <p className="text-white text-xl leading-relaxed max-w-2xl">
                  Création d'un site web avec WordPress &amp; Elementor
                </p>
              </section>
              ...
              <section className="fade-up d3 space-y-4">
                ...
                <p className="text-white text-xl leading-relaxed max-w-2xl">
                  Créer un site web WordPress finalisé à partir d'une maquette PDF client, en assurant une intégration correcte des images, une prise en main efficace de WordPress et d'Elementor, et le respect fidèle du design fourni.
                </p>
              </section>
              ...
              <section className="fade-up d4 space-y-4">
                ...
                <p className="text-white text-xl leading-relaxed">Web designer · Maître de stage</p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <GlassCard className="p-6">
                  <div className="grid md:grid-cols-2 gap-3">
                    {[
                      "Recherche de tutoriels pour des designs spécifiques",
                      "Mise en place précise des marges",
                      "Nombreux allers-retours entre les pages et le menu de WordPress",
                    ].map((item, i) => (

...
const Navbar = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/10 backdrop-blur-lg border-b border-white/10 shadow-xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo/Name */}
          <a
            href="/" 
            className="text-[1.5em] text-white font-semibold tracking-tight hover:text-purple-400 transition-colors duration-300"
          >
            CAPPELLO Alicia
          </a>
          ...
          {/* Navigation Links */}
          <ul className="text-[1.5em] hidden md:flex items-center gap-8">
            <li>
              <a 
                href="/" 

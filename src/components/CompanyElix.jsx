...
import Project1 from './ProjetParadisGeek';
import Project2 from './ProjetBridge';
...
<div id="back" className="h-screen overflow-auto">
    <div className="bg-white opacity-80 mt-40 rounded-lg shadow-lg relative p-6 mx-auto w-full p-30">
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-gray-700 text-sm">
            <li><Link to="/ParadisDuGeek" className="text-blue-600 hover:underline">Projet 1 : Paradis du Geek</Link></li>
